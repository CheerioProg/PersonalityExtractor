...
def build_new_data(revs):
    with open("/content/drive/MyDrive/PersonalityExtractor/essays_original_splitted.csv", "w") as output:
...
if __name__ == "__main__":
    x, y = build_data_cv("/content/drive/MyDrive/PersonalityExtractor/essays_original_splitted.csv")
    build_new_data(x)
